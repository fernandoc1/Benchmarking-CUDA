                               ...
                               const unsigned int iterations )
{
	...
	GpuProfiling::addResults("bisectKernelLarge");
	...
	GpuProfiling::prepareProfiling(  grid_onei , threads_onei  );
      bisectKernelLarge_OneIntervals<<< grid_onei , threads_onei >>>
          ( input.g_a, input.g_b, mat_size, num_one_intervals,
            result.g_left_one, result.g_right_one, result.g_pos_one,
            precision
          );
	GpuProfiling::addResults("bisectKernelLarge_OneIntervals");
	...
	GpuProfiling::prepareProfiling(  grid_mult, threads_mult  );
	...
	GpuProfiling::addResults("bisectKernelLarge_MultIntervals");
