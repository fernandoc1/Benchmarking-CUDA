...
namespace ir
{
	...
	class ILInstruction : public Instruction
	{
		public:
			...
			/*! \brief Verify if the instruction is a basic block terminator */
			...
			/*! \brief Verify if the instruction is a conditional branch */
			bool isConditionalBranch() const {
				if (opcode == IfLogicalZ) {
					return true;
				} else {
					return false;
				}
			...
			/*! \brief Verify if the instruction is an unconditional branch */
